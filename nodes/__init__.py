...
if 'PYTEST_CURRENT_TEST' not in os.environ:
    ...
    from .nodes_preprocessing import (
        NODE_CLASS_MAPPINGS as PREPROCESSING_NODE_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as PREPROCESSING_NODE_DISPLAY_NAME_MAPPINGS,
    )
    ...
    NODE_CLASS_MAPPINGS = {
        ...
        **PREPROCESSING_NODE_CLASS_MAPPINGS,
    }
    ...
    NODE_DISPLAY_NAME_MAPPINGS = {
        ...
        **PREPROCESSING_NODE_DISPLAY_NAME_MAPPINGS,
    }
else:
    NODE_CLASS_MAPPINGS = {}
    NODE_DISPLAY_NAME_MAPPINGS = {}
